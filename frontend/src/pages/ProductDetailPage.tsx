...
const ProductDetailPage =() =>{
    return(
        <div className="bg-[#E1E8E2] h-dvh flex-col">
            <div className="px-4 w-full">
                <PageHeader to={"/home"} label={""} />
                ...
                <div className=" w-full bg-secondary p-2 mt-3 rounded-lg">
            ...
            <div className="h-40 bottom-0 bg-gradient-to-t from-secondary to-transparent p-6 flex items-end fixed w-full bottom-0">
